const STEPS = [
  { title: "Upload dit CV som PDF", text: "eller opret et fra bunden" },
  { title: "Gennemse designet", text: "og lav dine ændringer med det samme" },
  { title: "Download nyt CV", text: "og ansøg jobbet med selvsikkerhed" },
];

export const Steps = () => {
  return (
    <section className="mx-auto mt-8 rounded-2xl bg-sky-50 px-8 pb-12 pt-10 lg:mt-2">
      <h1 className="text-center text-3xl font-bold">3 Simple Skridt</h1>
              ...
              <dt className="text-lg font-bold">
                <div className="bg-primary absolute left-0 top-1 flex h-10 w-10 select-none items-center justify-center rounded-full p-[3.5px] opacity-80">
                  <div className="flex h-full w-full items-center justify-center rounded-full bg-white">
                    <div className="text-primary -mt-0.5 text-xl">
                      {idx + 1}
                    </div>
                  </div>
                </div>
